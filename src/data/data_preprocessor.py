...
def imread(img, target_size, predict):
...
def preprocess_image(image, target_size, predict=False, augmentation=False):
    image, bg_intensity = imread(image, target_size, predict)
